...
package com.nitv.newsapp.databinding;
...
public final class ItemNewsBinding implements ViewBinding {
  ...
  private ItemNewsBinding(@NonNull CardView rootView, @NonNull ImageView imgHeadline,
  ...
  public static ItemNewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNewsBinding((CardView) rootView, imgHeadline, mainContainer, textSource,
          textTitle, txtDescription);
    }
